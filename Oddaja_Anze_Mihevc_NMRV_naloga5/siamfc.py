...
class TrackerSiamFC(Tracker):
    ...
    def __init__(self, net_path=None, **kwargs):
        ...
        # ---------------------- define parameters ----------------------
        self.not_detected_threshold = 0.8   # threshold for when the subject is considerd not detected TODO test for report
        ...
        self.gaussian_std = 20              # standard deviation for the gaussian distribution TODO test for report
        self.redetect_samples = 20          # number of samples to take for redetection TODO test for report
        ...
        self.sample_method = "random"     # method for sampling patches can be "random" or "gaussian" TODO test for report
